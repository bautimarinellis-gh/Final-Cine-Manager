namespace Vista.Módulo_de_Seguridad
{
    partial class FormAgregarGrupo
    {
        ...
        private void InitializeComponent()
        {
            ...
            TreeNode treeNode4 = new TreeNode("Gestionar Clientes");
            TreeNode treeNode5 = new TreeNode("Realizar Pedido");
            TreeNode treeNode6 = new TreeNode("Empleados", new TreeNode[] { treeNode4, treeNode5 });
            ...
            treeNode3.Tag = "Administradores";
            treeNode3.Text = "Administradores";
            treeNode4.Name = "nClientes";
            treeNode4.Tag = "Gestionar Clientes";
            treeNode4.Text = "Gestionar Clientes";
            treeNode5.Name = "nTransacciones";
            treeNode5.Tag = "Realizar Pedido";
            treeNode5.Text = "Realizar Pedido";
            treeNode6.Name = "nEmpleado";
            treeNode6.Tag = "Empleados";
            treeNode6.Text = "Empleados";
            treeViewAcciones.Nodes.AddRange(new TreeNode[] { treeNode3, treeNode6 });
