namespace Vista.Módulo_de_Seguridad
{
    partial class FormAgregarGrupo
    {
        ...
        private void InitializeComponent()
        {
            ...
            TreeNode treeNode6 = new TreeNode("Compras", new TreeNode[] { treeNode5 });
            TreeNode treeNode7 = new TreeNode("Gestionar Grupos");
            TreeNode treeNode8 = new TreeNode("Gestionar Usuarios");
            TreeNode treeNode9 = new TreeNode("Seguridad", new TreeNode[] { treeNode7, treeNode8 });
            TreeNode treeNode10 = new TreeNode("Gestionar Inventario");
            ...
            treeNode4.Tag = "Ventas";
            treeNode4.Text = "Ventas";
            treeNode5.Name = "nProveedores";
            treeNode5.Tag = "Gestionar Proveedores";
            treeNode5.Text = "Gestionar Proveedores";
            treeNode6.Name = "nCompras";
            treeNode6.Tag = "Compras";
            treeNode6.Text = "Compras";
            treeNode7.Name = "nGrupos";
            treeNode7.Tag = "Gestionar Grupos";
            treeNode7.Text = "Gestionar Grupos";
            treeNode8.Name = "nUsuarios";
            treeNode8.Tag = "Gestionar Usuarios";
            treeNode8.Text = "Gestionar Usuarios";
            treeNode9.Name = "nSeguridad";
            treeNode9.Tag = "Seguridad";
            treeNode9.Text = "Seguridad";
            treeNode10.Name = "nInventario";
            treeNode10.Tag = "Gestionar Inventario";
            treeNode10.Text = "Gestionar Inventario";
            treeViewAcciones.Nodes.AddRange(new TreeNode[] { treeNode4, treeNode6, treeNode9, treeNode10 });
