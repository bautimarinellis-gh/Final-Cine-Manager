...
namespace Vista.Módulo_de_Seguridad
{
    public partial class FormIniciarSesion : Form
    {
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (usuario.EstadoUsuario.EstadoUsuarioId != 1) // Asumiendo que el Id 2 representa 'Inactivo'
            {
            ...
            // Guardar la sesión en un lugar accesible globalmente
            Sesion.Instancia = sesion;
            ...
            // Configurar y mostrar el formulario principal
