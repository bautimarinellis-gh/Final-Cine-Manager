namespace Vista.Módulo_de_Seguridad
{
    partial class FormDatosUsuario
    {
        ...
        {
            TreeNode treeNode1 = new TreeNode("Gestionar Grupos");
            TreeNode treeNode2 = new TreeNode("Gestionar Usuarios");
            TreeNode treeNode3 = new TreeNode("Administradores", new TreeNode[] { treeNode1, treeNode2 });
            TreeNode treeNode4 = new TreeNode("Gestionar Pedidos");
            TreeNode treeNode5 = new TreeNode("Gestionar Peliculas");
            TreeNode treeNode6 = new TreeNode("Gestionar Clientes");
            TreeNode treeNode7 = new TreeNode("Realizar Pedido");
            TreeNode treeNode8 = new TreeNode("Empleados", new TreeNode[] { treeNode4, treeNode5, treeNode6, treeNode7 });
            ...
            treeNode1.Name = "nGrupos";
            treeNode1.Tag = "Gestionar Grupos";
            treeNode1.Text = "Gestionar Grupos";
            treeNode2.Name = "nUsuarios";
            treeNode2.Tag = "Gestionar Usuarios";
            treeNode2.Text = "Gestionar Usuarios";
            treeNode3.Name = "nAdministrador";
            treeNode3.Text = "Administradores";
            treeNode4.Name = "nPedido";
            treeNode4.Tag = "Gestionar Pedidos";
            treeNode4.Text = "Gestionar Pedidos";
            treeNode5.Name = "nInventario";
            treeNode5.Tag = "Gestionar Peliculas";
            treeNode5.Text = "Gestionar Peliculas";
            treeNode6.Name = "nClientes";
            treeNode6.Tag = "Gestionar Clientes";
            treeNode6.Text = "Gestionar Clientes";
            treeNode7.Name = "nTransacciones";
            treeNode7.Tag = "Realizar Pedido";
            treeNode7.Text = "Realizar Pedido";
            treeNode8.Name = "nEmpleado";
            treeNode8.Tag = "Empleados";
            treeNode8.Text = "Empleados";
            treeView1.Nodes.AddRange(new TreeNode[] { treeNode3, treeNode8 });
